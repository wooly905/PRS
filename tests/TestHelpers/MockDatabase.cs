...
public class MockDatabase : IDatabase
{
    ...
    public static MockDatabase CreateTestData()
    {
        ...
        // Add test tables
        mock.Tables.Add(new TableModel { TableSchema = "dbo", TableName = "Users", TableType = "BASE TABLE" });
        mock.Tables.Add(new TableModel { TableSchema = "dbo", TableName = "Orders", TableType = "BASE TABLE" });
        mock.Tables.Add(new TableModel { TableSchema = "dbo", TableName = "Products", TableType = "BASE TABLE" });
